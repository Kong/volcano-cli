...
For the internal staging build, install `volcano-staging` (coexists with a
production `volcano`) — see [Installation details](docs/installation.md#staging-channel).
